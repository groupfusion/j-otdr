...
public class CRC16Util {
    ...
    public static String getCrc(int res) {
        ...
        System.out.println("crc ---- : " + substring + "  " + substring1);
...
//        byte[] bytes = args.getBytes();
        ...
        crc &= 0xffff;
        System.out.println("CRC16-CCITT = " + Integer.toHexString(crc)+",crc:"+crc);
        return crc;
    }

    public static void main(String [] args){
        String test="abcdefghij";
        int crc = CRC16Util.crc16ccitt(test.getBytes());
        System.out.println(crc);
        int cc = CRC16Util.calcCrc16(test.getBytes());
